...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("hide-control-input".to_string(), "Y".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["id.rust.pzke.cn"];
pub const RS_PUB_KEY: &str = "WS5SF5kYxQwWCnfNC0G0WZ+C65ucoBWgmcisPdY2mDE=";
